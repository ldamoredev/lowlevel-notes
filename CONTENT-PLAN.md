...
- [ ] **pointers-and-memory** — index ✓ · **5/15 notes DONE** (✓ what-a-pointer-really-is · ✓ pointer-arithmetic-and-stride · ✓ the-stack-frames-locals-and-automatic-storage · ✓ the-heap-malloc-free-and-the-allocator-underneath · ✓ pointers-to-pointers-double-indirection · flagship; keep the quality bar here)
