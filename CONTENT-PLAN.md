...
- [ ] **assembly-and-compiler-output** — index ✓ · **4/12 notes** (✓ why-read-assembly-compiler-explorer · ✓ x86-64-registers-and-the-register-file · ✓ core-instruction-set-mov-arithmetic-lea · ✓ addressing-modes-and-memory-operands · EN+ES)
